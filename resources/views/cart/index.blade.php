                   ...
                   @if (empty($cartItems))
                    ...
                    @else
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('orders.checkout') }}" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700">
                                購入手続きへ進む (未実装)
                            </a>
                        </div>
                    @endif
