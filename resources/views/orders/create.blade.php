                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('orders.store') }}" method="POST">
                        ...
                        <div id="delivery-config"
                            ...
                            data-time-slots="{{ json_encode(config('delivery.delivery_time_slots')) }}"
                        ></div>
                        ...
                        <div class="mb-6 p-4 bg-yellow-50 rounded-lg text-yellow-800 font-semibold">
                            ...
                            <p id="earliest-arrival-message" class="text-sm text-yellow-700 mt-1"></p>
                        </div>
